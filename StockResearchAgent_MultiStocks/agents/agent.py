...
qualitative_agent = LlmAgent(
    ...
    output_key="QualitativeAnalyst_Output",
    instruction="""
...
quantitative_agent = LlmAgent(
    ...
    tools=[google_search],
    include_contents='none', # CRITICAL: Wipes context
    output_key="QuantitativeAnalyst_Output",
    instruction="""
...
valuation_agent = LlmAgent(
    ...
    tools=[google_search],
    include_contents='none', # CRITICAL: Wipes context
    output_key="ValuationAnalyst_Output",
    instruction="""
...
report_agent = LlmAgent(
    ...
    Qualitative Agent's Full Report :-  ## Make it bold header ##
    {QualitativeAnalyst_Output}
    ## Insert a line break here ##

    Quantitative Agent's Full Report :-  ## Make it bold header ##
    {QuantitativeAnalyst_Output}
    ## Insert a line break here ##

    Valuation Agent's Full Report :-  ## Make it bold header ##
    {ValuationAnalyst_Output}
    ## Insert a line break here ##
